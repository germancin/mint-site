...
5. CUSTOM By German
```sh
$ truffle exec src/backEnd/scripts/manual-mint.js --network ganache_cli createJsonFiles 
$ 
```

```sh
  Before running this command you will have to upload the json files to pinata
  and get the CID and add it into manual-mint.js line# 96sh

  $ truffle exec src/backEnd/scripts/manual-mint.js --network ganache_cli mintJsonFiles
  $ 
```
